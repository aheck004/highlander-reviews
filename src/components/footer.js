    ...
    <ThemeProvider theme={theme}>
      ...
      >
        ...
        >
          ...
          >
            <Typography fontSize={isMobile ? ".7rem" : ".9rem"} color="primary.contrastText">About</Typography>
          </Link>
          <Typography 
            sx={{ flex: 1, textAlign: "center" }}
            fontSize={isMobile ? ".7rem" : ".9rem"} color="primary.contrastText">|</Typography>
          <Link
            ...
            sx={{ color: "primary.contrastText" }}
          >
            <Typography fontSize={isMobile ? ".7rem" : ".9rem"} color="primary.contrastText">Feedback</Typography>
          </Link>
          <Typography 
            sx={{ flex: 1, textAlign: "center" }}
            fontSize={isMobile ? ".7rem" : ".9rem"} color="primary.contrastText">|</Typography>
          <Link
            ...
            sx={{ color: "primary.contrastText" }}
          >
            <Typography fontSize={isMobile ? ".7rem" : ".9rem"} color="primary.contrastText">Bug Report</Typography>
          </Link>
          <Typography
            sx={{ flex: 1, textAlign: "center" }}
            fontSize={isMobile ? ".7rem" : ".9rem"} color="primary.contrastText">|</Typography>
